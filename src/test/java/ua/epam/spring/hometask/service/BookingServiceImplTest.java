...
public class BookingServiceImplTest extends AbstractTest {
    ...
    public void getTicketsPrice() throws Exception {
        ...
        double actualValue = bookingServiceImpl.getTicketsPrice(event,data,user,seats);
    ...
    public void getPurchasedTicketsForEvent() throws Exception {
        ...
        */
        ...
        Set<Ticket> Result = bookingServiceImpl.getPurchasedTicketsForEvent(event3,localDateTime2);
